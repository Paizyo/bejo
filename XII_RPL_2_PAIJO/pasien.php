                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link actie" href="#">Pasien</a>
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    ?>
                        <tr>
                            ...
                            <a href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apa Anda Yakin Ingin Menghapus Data?')">Hapus</a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
